...
### 有关我
JoyWonderful，注册 GitHub 时自己乱取的名字。简称有 jywondf, jywon。~~（没有 jywdf 这种简称，太不雅观了）~~  
从博客内文章可以推断出~~曾~~是一名 **OIer**。  
但是学会的前端的皮毛似乎与 OI 无直接关系，不是吗？

GitHub: [@JoyWonderful](https://github.com/JoyWonderful)

### 文章许可
除特殊说明外，所有文章使用[知识共享 署名—非商业性使用 4.0 协议](https://creativecommons.org/licenses/by-nc/4.0/deed.zh-hans)，即 CC BY-NC 4.0。  
即转载时必须**提供作者署名**及**原文链接**，且**不得**将文章用于**商业目的**。
