---
title: 二叉树的性质
date: 2024-03-31 15:23:12 +08:00
tags:
    - 树
    - 数据结构
...
## 几种类型
这里只说之前没有记过的类型，之前两（三）种类型看[数据结构：树的概念与储存](/posts/graph-tree/#二叉树的概念)。

### 二叉搜索树
二叉树上的任意一个结点，其**左子树上的所有数（权值）都小于它，右子树上的所有数（权值）都大于它**。就是按照中序遍历（看[二叉树的前序、中序、后序遍历](/posts/binarytree-fme)）该二叉搜索树，得到的（权值）数列是有序的。  
...
![bitree-search](/images/binarytree/bittreeSearch.webp)
...
![tree](/images/binarytree/tree.webp)
